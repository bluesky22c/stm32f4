...
/* Private functions ---------------------------------------------------------*/
u32   g_itFirst_Flag = 0;

extern vu32    ir_count_100us;        
extern timer_msg_type_t        g_SystemTimer;
...
void USART1_IRQHandler(void)
{
  ...
  if (USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)
  {
    ...
    /* transfer character to usart2 */
    //SerialPutChar(USART2, ch);
  }
}
